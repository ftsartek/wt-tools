...
@pytest.mark.skip(reason="Can't find old files now")
class TestOldBlk:
    def test_old_blk_in_strict_blk_mode(self):
        expected_data, result_data = read_and_unpack(
            "camera.old.blk",
            "camera.old.blkx",
    ...
    def test_old_blk_in_json_mode(self):
        expected_data, result_data = read_and_unpack(
            "camera.old.blk", "camera.old.json.blkx", blk_unpack.BLK.output_type["json"]
        )
        assert result_data == expected_data, "Wrong output blkx"
...
class TestNewBlk:
    ...
    def test_new_blk_in_json_mode(self):
        expected_data, result_data = read_and_unpack(
            "camera.new.blk", "camera.new.json.blkx", blk_unpack.BLK.output_type["json"]
        )
        assert result_data == expected_data, "Wrong output blkx"
    ...
    def test_new_blk_with_big_num_of_units_and_subunits(self):
        ...
        """
        expected_data, result_data = read_and_unpack(
            "gui.blk", "gui.blkx", blk_unpack.BLK.output_type["strict_blk"]
        )
        assert result_data == expected_data, "Wrong output blkx"
    ...
    def test_new_blk_with_spaces_in_key(self):
        ...
        """
        expected_data, result_data = read_and_unpack(
            "assaults_template.blk",
            "assaults_template.blkx",
            blk_unpack.BLK.output_type["strict_blk"],
        )
        assert result_data == expected_data, "Wrong output blkx"
    ...
    def test_new_blk_with_array_type(self):
        ...
        """
        expected_data, result_data = read_and_unpack(
            "bzt_part.blk", "bzt_part.blkx", blk_unpack.BLK.output_type["strict_blk"]
        )
        assert result_data == expected_data, "Wrong output blkx"
    ...
    def test_new_blk_with_big_unit_length(self):
        ...
        """
        expected_data, result_data = read_and_unpack(
            "ct_test.blk", "ct_test.blkx", blk_unpack.BLK.output_type["strict_blk"]
        )
        assert result_data == expected_data, "Wrong output blkx"
    ...
    def test_new_blk_with_utf8_strings(self):
        ...
        """
        expected_data, result_data = read_and_unpack(
            "lpt_part.blk", "lpt_part.blkx", blk_unpack.BLK.output_type["json"]
        )
        assert result_data == expected_data, "Wrong output blkx"
