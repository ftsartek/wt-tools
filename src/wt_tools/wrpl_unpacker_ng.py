...
def serialize_text(
    root: Section, ostream: t.TextIO, out_type: int, is_sorted: bool = False
):
...
def main():
    ...
    try:
        ...
        print(
            "Ошибка при создании выходной директории {}: {}".format(out_dir, e),
            file=sys.stderr,
        )
        return 1
    ...
    try:
        ...
        print(
            "Ошибка при разборе входного файла {}: {}".format(replay.name, e),
            file=sys.stderr,
        )
        return 1
