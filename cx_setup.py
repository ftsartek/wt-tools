...
includefiles = [
    os.path.join(src_path, "./formats/blk.lark"),
...
blk_unpack_ng = Executable(script=os.path.join(src_path, "blk_unpack_ng.py"))

blk_unpack_ng_mp = Executable(script=os.path.join(src_path, "blk_unpack_ng_mp.py"))
...
wrpl_unpacker_ng = Executable(script=os.path.join(src_path, "wrpl_unpacker_ng.py"))
